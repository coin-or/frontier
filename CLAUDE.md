...
| [`architecture.md`](architecture.md) | System architecture: tools, skills, data flow, state lifecycle |
| [`best-practices.md`](best-practices.md) | Skill, prompt, and MCP design guidelines (Anthropic-sourced) |
| [`frontier/skills/`](frontier/skills/) | Agent skill files (MCP resources) — see best-practices.md for design principles |
