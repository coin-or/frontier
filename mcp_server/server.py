...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "Batch generously: put as many triples in one model/update call as your output comfortably holds "
        "— a small problem's whole score set at once, or one objective's full column at a time for a large "
        "one. Entering scores option-by-option is slow and needless; upsert means you can split batches "
        "however is convenient and re-send to correct.\n\n"
        "## Objective Schema\n"
