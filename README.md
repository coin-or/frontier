...
| **OpenAI** | `openai-compatible` | `OPENAI_API_KEY`, `OPENAI_MODEL`; models that gate tools behind the Responses API (e.g. GPT-5.6 family) also set `OPENAI_WIRE=responses` |
