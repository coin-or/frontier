...
<p align="center">
  <strong>Multi-objective decision optimization agent toolkit. An architecture pattern for decisions LLMs can't solve alone. Use in any MCP client or via the integrated web UI.</strong>
</p>
